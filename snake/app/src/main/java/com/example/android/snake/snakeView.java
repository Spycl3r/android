...
class SnakeView extends SurfaceView implements Runnable {
    ...
    // The current m_Score
    private int m_Score;
    // Track the number of drawn frames
    private int m_DrawnFrames;
    ...
    public void startGame() {
        // Set variable to 0 for new game
        m_DrawnFrames = 0;

        // Start with just a head, in the middle of the screen
        m_SnakeLength = 3;
        m_SnakeXs[0] = NUM_BLOCKS_WIDE / 3;
        m_SnakeYs[0] = m_NumBlocksHigh / 3;
    ...
    public void updateGame() {
        // Track the number of frames drawn
        m_DrawnFrames++;
    ...
    public void drawGame() {
        ...
        if (m_Holder.getSurface().isValid()) {
            ...
            m_Paint.setColor(Color.argb(255, 105, 180, 24));

            // Choose how big the score will be
            m_Paint.setTextSize(50);
            m_Canvas.drawText("Score:" + m_Score, 10, 50, m_Paint);
            m_Canvas.drawText("Drawn Frame:" + m_DrawnFrames, 10, 100, m_Paint);
